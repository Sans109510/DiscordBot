...
module.exports = {
    ...
    async run(bot, message, args, db) {
        ...
        if(message.user.id !== "754743152404856872" && (parseInt(number) <= 0 || parseInt(number) > 9999)) return message.reply("Non! Le nombre d'exp à giveaway doit etre entre 0 et 9999.")
